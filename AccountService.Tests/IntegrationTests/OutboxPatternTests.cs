...
public class OutboxPatternTests(WebAppFactory factory) : RabbitMqIntegrationTestBase, IClassFixture<WebAppFactory>
{
    ...
    public record AccountOpenedEventPayload(Guid OwnerId, string Currency, string Type, Guid AccountId);
}
using AccountService.Features.AccountFeatures.ChangeAccountInterestRate;
using AccountService.Features.AccountFeatures.CreateNewAccount;
using AccountService.Features.AccountFeatures.GetAccounts;
using AccountService.Features.AccountFeatures.RemoveAccount;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace AccountService.Features.AccountFeatures;

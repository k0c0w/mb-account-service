...
namespace AccountService.Persistence.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20250819010700_Replaced_AccrueInterest_Procedure")]
    public class Replaced_AccrueInterest_Procedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                 ...
                 CREATE PROCEDURE accrue_interest(
                     p_account_id UUID,
                     OUT p_from_date DATE,
                     OUT p_to_date DATE,
                     OUT p_amount_added NUMERIC,
                     OUT p_was_accrued BOOLEAN
                 )
                 LANGUAGE plpgsql
                 AS $$
                 DECLARE
                 ...
                 BEGIN
                     ...
                     -- Set output from date
                     p_from_date := last_accrual_date;
                     
                     -- Number of full days since last accrual
                     days_missing := p_to_date - last_accrual_date;
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                     CREATE PROCEDURE accrue_interest(p_account_id UUID)
                     LANGUAGE plpgsql
                     AS $$
                     DECLARE
                         acc RECORD;
